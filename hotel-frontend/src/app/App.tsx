      ...
      <div className="flex h-screen bg-gray-100">
        ...
        <main className="flex-1 overflow-y-auto">
          <Routes>
            ...
            <Route path="/reports"         element={<ProtectedRoute allowedRoles={['Quản lý', 'Admin', 'Thủ kho']}><ReportPage /></ProtectedRoute>} />

            {/* BM 4.3 — Tra cứu phiếu đặt */}
            <Route path="/booking-search"  element={<ProtectedRoute allowedRoles={['Lễ tân', 'Quản lý', 'Admin']}><BookingSearch /></ProtectedRoute>} />
